        ...
        if (ext.isReady) {
            ...
            try {
                ...
                if ("{男科疾病}" == "0") {
                    ...
                    Enter(list, f, "check", "睾丸炎、附睾炎", eval("{睾丸炎}"));
                    Enter(list, f, "check", "精索静脉曲张", eval("{精索静脉曲张}"));
                    Enter(list, f, "check", "不育症", eval("{不育症}"));
                    Enter(list, f, "check", "腮腺炎", eval("{腮腺炎}"));
                    Enter(list, f, "check", "其他", eval("{其他男科疾病}"));
