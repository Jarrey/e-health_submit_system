        ...
        var i = setInterval(function () {
            ...
            if (!IsLoadingData(d) && ext.isReady) {
                ...
                try {
                    ...
                    if ("{尿常规}" == "0") {
                        Enter(fieldSet, f, "combo", "尿液常规检查", "未见异常");		// "未见异常"
                        ext.getCmp("urineRoutineDescribe").reset();
                        ext.getCmp("urineRoutineDescribe").disable();
                    } else if ("{尿常规}" == "1") {
                        Enter(fieldSet, f, "combo", "尿液常规检查", "^异常");		// "异常"
                        ext.getCmp("urineRoutineDescribe").enable();
                        ext.getCmp("urineRoutineDescribe").validate();
